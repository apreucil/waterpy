...
def check_config_options(config):
    ...
    options = {
        ...
        "snowmelt": config["Options"]["option_snowmelt"].lower().strip(),
        "min_max": config["Options"]["option_max_min"].lower().strip(),
        "rain_dist": config["Options"]["option_distribution_record"].lower().strip(),
        "forecast": config["Options"]["option_forecast"].lower().strip()
    }
